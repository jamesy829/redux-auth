  ...
  /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _authenticate = __webpack_require__(73);
        ...
        var _emailSignIn = __webpack_require__(90);
        ...
        var _signOut = __webpack_require__(91);
        ...
        var _emailSignUp = __webpack_require__(92);
        ...
        var _oauthSignIn = __webpack_require__(93);
        ...
        var _requestPasswordReset = __webpack_require__(95);
        ...
        var _updatePassword = __webpack_require__(96);
        ...
        var _updatePasswordModal = __webpack_require__(97);
        ...
        var _destroyAccount = __webpack_require__(98);
        ...
        var _sessionStorage = __webpack_require__(79);
        ...
        var _fetch = __webpack_require__(77);
        ...
        var _authenticate2 = __webpack_require__(99);

        var _authenticate3 = _interopRequireDefault(_authenticate2);

        var _configure2 = __webpack_require__(101);
        ...
        var _ui2 = __webpack_require__(103);

        var _ui3 = _interopRequireDefault(_ui2);

        var _emailSignIn2 = __webpack_require__(104);

        var _emailSignIn3 = _interopRequireDefault(_emailSignIn2);

        var _emailSignUp2 = __webpack_require__(105);

        var _emailSignUp3 = _interopRequireDefault(_emailSignUp2);

        var _oauthSignIn2 = __webpack_require__(106);

        var _oauthSignIn3 = _interopRequireDefault(_oauthSignIn2);

        var _requestPasswordReset2 = __webpack_require__(107);

        var _requestPasswordReset3 = _interopRequireDefault(
          _requestPasswordReset2
        );

        var _updatePassword2 = __webpack_require__(108);

        var _updatePassword3 = _interopRequireDefault(_updatePassword2);

        var _updatePasswordModal2 = __webpack_require__(109);

        var _updatePasswordModal3 = _interopRequireDefault(
          _updatePasswordModal2
        );
        ...
        var _signOut2 = __webpack_require__(111);

        var _signOut3 = _interopRequireDefault(_signOut2);

        var _destroyAccount2 = __webpack_require__(112);

        var _destroyAccount3 = _interopRequireDefault(_destroyAccount2);

        var _reduxImmutablejs = __webpack_require__(100);

        var _verifyAuth2 = __webpack_require__(83);

        var _verifyAuth3 = _interopRequireDefault(_verifyAuth2);

        var _handleFetchResponse = __webpack_require__(82);
        ...
        /* reducers */
        var authStateReducer = (exports.authStateReducer = (0,
        _reduxImmutablejs.combineReducers)({
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _verifyAuth = __webpack_require__(83);

        var _verifyAuth2 = _interopRequireDefault(_verifyAuth);

        var _parseUrl = __webpack_require__(85);

        var _parseUrl2 = _interopRequireDefault(_parseUrl);

        var _reactRouterRedux = __webpack_require__(89);
        ...
        var SET_ENDPOINT_KEYS = (exports.SET_ENDPOINT_KEYS =
          "SET_ENDPOINT_KEYS");
        var STORE_CURRENT_ENDPOINT_KEY = (exports.STORE_CURRENT_ENDPOINT_KEY =
          "STORE_CURRENT_ENDPOINT_KEY");
        function setEndpointKeys(
          endpoints,
          currentEndpointKey,
          defaultEndpointKey
        ) {
        ...
        function storeCurrentEndpointKey(currentEndpointKey) {
          return {
            type: STORE_CURRENT_ENDPOINT_KEY,
            currentEndpointKey: currentEndpointKey
          };
        }
        ...
        function configure() {
          ...
          return function(dispatch) {
            ...
            if (settings.isServer) {
              promise = (0, _verifyAuth2.default)(endpoint, settings)
                .then(function(_ref) {
                  var user = _ref.user,
      ...
      /***/ function(module, exports) {
        ...
        var DEFAULT_CONFIG_KEY = (exports.DEFAULT_CONFIG_KEY =
          "defaultConfigKey");
      ...
      /***/ function(module, exports) {
        ...
        var AUTHENTICATE_START = (exports.AUTHENTICATE_START =
          "AUTHENTICATE_START");
        var AUTHENTICATE_COMPLETE = (exports.AUTHENTICATE_COMPLETE =
          "AUTHENTICATE_COMPLETE");
        var AUTHENTICATE_ERROR = (exports.AUTHENTICATE_ERROR =
          "AUTHENTICATE_ERROR");
      ...
      /***/ function(module, exports) {
        ...
        var HIDE_EMAIL_SIGN_IN_SUCCESS_MODAL = (exports.HIDE_EMAIL_SIGN_IN_SUCCESS_MODAL =
          "HIDE_EMAIL_SIGN_IN_SUCCESS_MODAL");
        var HIDE_EMAIL_SIGN_IN_ERROR_MODAL = (exports.HIDE_EMAIL_SIGN_IN_ERROR_MODAL =
          "HIDE_EMAIL_SIGN_IN_ERROR_MODAL");
        var HIDE_OAUTH_SIGN_IN_SUCCESS_MODAL = (exports.HIDE_OAUTH_SIGN_IN_SUCCESS_MODAL =
          "HIDE_OAUTH_SIGN_IN_SUCCESS_MODAL");
        var HIDE_OAUTH_SIGN_IN_ERROR_MODAL = (exports.HIDE_OAUTH_SIGN_IN_ERROR_MODAL =
          "HIDE_OAUTH_SIGN_IN_ERROR_MODAL");
        var HIDE_SIGN_OUT_ERROR_MODAL = (exports.HIDE_SIGN_OUT_ERROR_MODAL =
          "HIDE_SIGN_OUT_ERROR_MODAL");
        var HIDE_SIGN_OUT_SUCCESS_MODAL = (exports.HIDE_SIGN_OUT_SUCCESS_MODAL =
          "HIDE_SIGN_OUT_SUCCESS_MODAL");
        var HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL = (exports.HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL =
          "HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL");
        var HIDE_EMAIL_SIGN_UP_ERROR_MODAL = (exports.HIDE_EMAIL_SIGN_UP_ERROR_MODAL =
          "HIDE_EMAIL_SIGN_UP_ERROR_MODAL");
        var SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL = (exports.SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL =
          "SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL");
        var HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL = (exports.HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL =
          "HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL");
        var HIDE_PASSWORD_RESET_SUCCESS_MODAL = (exports.HIDE_PASSWORD_RESET_SUCCESS_MODAL =
          "HIDE_PASSWORD_RESET_SUCCESS_MODAL");
        var SHOW_PASSWORD_RESET_SUCCESS_MODAL = (exports.SHOW_PASSWORD_RESET_SUCCESS_MODAL =
          "SHOW_PASSWORD_RESET_SUCCESS_MODAL");
        var SHOW_FIRST_TIME_LOGIN_ERROR_MODAL = (exports.SHOW_FIRST_TIME_LOGIN_ERROR_MODAL =
          "SHOW_FIRST_TIME_LOGIN_ERROR_MODAL");
        var HIDE_FIRST_TIME_LOGIN_ERROR_MODAL = (exports.HIDE_FIRST_TIME_LOGIN_ERROR_MODAL =
          "HIDE_FIRST_TIME_LOGIN_ERROR_MODAL");
        var HIDE_PASSWORD_RESET_ERROR_MODAL = (exports.HIDE_PASSWORD_RESET_ERROR_MODAL =
          "HIDE_PASSWORD_RESET_ERROR_MODAL");
        var SHOW_PASSWORD_RESET_ERROR_MODAL = (exports.SHOW_PASSWORD_RESET_ERROR_MODAL =
          "SHOW_PASSWORD_RESET_ERROR_MODAL");
        var HIDE_REQUEST_PASSWORD_RESET_SUCCESS_MODAL = (exports.HIDE_REQUEST_PASSWORD_RESET_SUCCESS_MODAL =
          "HIDE_REQUEST_PASSWORD_RESET_SUCCESS_MODAL");
        var HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL = (exports.HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL =
          "HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL");
        var HIDE_UPDATE_PASSWORD_SUCCESS_MODAL = (exports.HIDE_UPDATE_PASSWORD_SUCCESS_MODAL =
          "HIDE_UPDATE_PASSWORD_SUCCESS_MODAL");
        var HIDE_UPDATE_PASSWORD_ERROR_MODAL = (exports.HIDE_UPDATE_PASSWORD_ERROR_MODAL =
          "HIDE_UPDATE_PASSWORD_ERROR_MODAL");
        var HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL = (exports.HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL =
          "HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL");
        var HIDE_DESTROY_ACCOUNT_ERROR_MODAL = (exports.HIDE_DESTROY_ACCOUNT_ERROR_MODAL =
          "HIDE_DESTROY_ACCOUNT_ERROR_MODAL");
      ...
      /***/ function(module, exports) {
        ...
        var SS_AUTH_TOKEN_UPDATE = (exports.SS_AUTH_TOKEN_UPDATE =
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _parseEndpointConfig2 = __webpack_require__(81);

        var _parseEndpointConfig3 = _interopRequireDefault(
          _parseEndpointConfig2
        );
        ...
        var defaultSettings = {
          ...
          handleAccountUpdateResponse: function handleAccountUpdateResponse(
            resp
          ) {
            return resp.data;
          },

          handleTokenValidationResponse: function handleTokenValidationResponse(
            resp
          ) {
            return resp.data;
          }
        ...
        function applyConfig() {
          ...
          (0, _sessionStorage.setCurrentSettings)(
            (0, _extend2.default)({}, defaultSettings, settings)
          );

          var _parseEndpointConfig = (0, _parseEndpointConfig3.default)(
              endpoint,
              (0, _sessionStorage.getInitialEndpointKey)()
            ),
          ...
          if ((0, _sessionStorage.getCurrentSettings)().initialCredentials) {
            ...
            var headers = (0, _sessionStorage.getCurrentSettings)()
              .initialCredentials.headers;

            (0, _sessionStorage.persistData)(C.SAVED_CREDS_KEY, headers);
            return (0, _fetch2.default)(
              "" +
                (0, _sessionStorage.getApiUrl)(currentEndpointKey) +
                currentEndpoint[currentEndpointKey].tokenValidationPath
            ).then(function(response) {
              return (0, _handleFetchResponse.parseResponse)(
                response,
                function() {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = function(url) {
          ...
          return (0, _isomorphicFetch2.default)(url, options).then(function(
            resp
          ) {
            if (isApiRequest(url)) {
        ...
        var isApiRequest = function isApiRequest(url) {
          return url.match(
            (0, _sessionStorage.getApiUrl)(
              (0, _sessionStorage.getSessionEndpointKey)()
            )
          );
        };
        ...
        function getAuthHeaders(url) {
          if (isApiRequest(url)) {
            ...
            var currentHeaders =
                (0, _sessionStorage.retrieveData)(C.SAVED_CREDS_KEY) || {},
              nextHeaders = {};
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _browserCookies = __webpack_require__(80);
        ...
        function getInitialEndpointKey() {
          return unescapeQuotes(
            _browserCookies2.default.get(C.SAVED_CONFIG_KEY) ||
              (root.localStorage &&
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function parseEndpointConfig(endpoint) {
          ...
          for (var i = 0; i < endpoint.length; i++) {
            ...
            currentEndpoint[configName] = (0, _extend2.default)(
              {},
              defaultEndpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _cookie = __webpack_require__(84);
        ...
        var _parseEndpointConfig3 = __webpack_require__(81);

        var _parseEndpointConfig4 = _interopRequireDefault(
          _parseEndpointConfig3
        );
        ...
        function fetchToken(_ref) {
          ...
          var _getRedirectInfo = (0, _parseUrl2.default)(
              _url2.default.parse(currentLocation)
            ),
            authRedirectHeaders = _getRedirectInfo.authRedirectHeaders;
          ...
          return new Promise(function(resolve, reject) {
            if (cookies || authRedirectHeaders) {
              ...
              if (
                ...
                firstTimeLogin = JSON.parse(
                  parsedCookies.firstTimeLogin || "false"
                );
              }
              ...
              var newHeaders,
                _parseEndpointConfig = (0, _parseEndpointConfig4.default)(
                  rawEndpoints
                ),
                currentEndpoint = _parseEndpointConfig.currentEndpoint,
                defaultEndpointKey = _parseEndpointConfig.defaultEndpointKey,
                _currentEndpoint =
                  currentEndpoint[currentEndpointKey || defaultEndpointKey],
                apiUrl = _currentEndpoint.apiUrl,
                tokenValidationPath = _currentEndpoint.tokenValidationPath,
                validationUrl =
                  "" + apiUrl + tokenValidationPath + "?unbatch=true";

              return (0, _isomorphicFetch2.default)(validationUrl, {
                headers: (0, _fetch.addAuthorizationHeader)(
              ...
              var _parseEndpointConfig2 = (0, _parseEndpointConfig4.default)(
                  rawEndpoints
                ),
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var stripAuthKeysAndNormalize = function stripAuthKeysAndNormalize(
          targetString,
          authKeys
        ) {
        ...
        var normalizeSearch = function normalizeSearch(location, authKeys) {
          var newSearch = stripAuthKeysAndNormalize(
        ...
        var getLocationWithoutAuthParams = function getLocationWithoutAuthParams(
          currentLocation,
          authKeys
        ) {
        ...
        function getRedirectInfo(currentLocation) {
          if (!currentLocation) {
            ...
            var authRedirectHeaders = buildCredentials(
              currentLocation,
              authKeys
            );
            ...
            if (authRedirectLocation !== currentLocation) {
              return {
                authRedirectHeaders: authRedirectHeaders,
                authRedirectLocation: authRedirectLocation
              };
            } else {
              return {};
            }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var EMAIL_SIGN_IN_START = (exports.EMAIL_SIGN_IN_START =
          "EMAIL_SIGN_IN_START");
        var EMAIL_SIGN_IN_COMPLETE = (exports.EMAIL_SIGN_IN_COMPLETE =
          "EMAIL_SIGN_IN_COMPLETE");
        var EMAIL_SIGN_IN_ERROR = (exports.EMAIL_SIGN_IN_ERROR =
          "EMAIL_SIGN_IN_ERROR");
        var EMAIL_SIGN_IN_FORM_UPDATE = (exports.EMAIL_SIGN_IN_FORM_UPDATE =
        ...
        function emailSignIn(body, endpointKey) {
          return function(dispatch) {
            ...
            var currentEndpointKey = (0,
            _sessionStorage.getCurrentEndpointKey)();

            dispatch(
              (0, _configure.storeCurrentEndpointKey)(currentEndpointKey)
            );
            dispatch(emailSignInStart(currentEndpointKey));

            return (0, _fetch2.default)(
              (0, _sessionStorage.getEmailSignInUrl)(currentEndpointKey),
              {
                headers: {
              ...
              .catch(function(_ref) {
                ...
                dispatch(
                  (0, _configure.storeCurrentEndpointKey)(prevEndpointKey)
                );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var SIGN_OUT_COMPLETE = (exports.SIGN_OUT_COMPLETE =
          "SIGN_OUT_COMPLETE");
        ...
        function signOut(endpoint) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getSignOutUrl)(endpoint),
              { method: "delete" }
            )
              .then(_handleFetchResponse.parseResponse)
              .then(function(user) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var EMAIL_SIGN_UP_START = (exports.EMAIL_SIGN_UP_START =
          "EMAIL_SIGN_UP_START");
        var EMAIL_SIGN_UP_COMPLETE = (exports.EMAIL_SIGN_UP_COMPLETE =
          "EMAIL_SIGN_UP_COMPLETE");
        var EMAIL_SIGN_UP_ERROR = (exports.EMAIL_SIGN_UP_ERROR =
          "EMAIL_SIGN_UP_ERROR");
        var EMAIL_SIGN_UP_FORM_UPDATE = (exports.EMAIL_SIGN_UP_FORM_UPDATE =
        ...
        function emailSignUp(body, endpointKey) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getEmailSignUpUrl)(endpointKey),
              {
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json"
                ...
                method: "post",
                body: JSON.stringify(
                  (0, _extend2.default)(body, {
                    confirm_success_url: (0,
                    _sessionStorage.getConfirmationSuccessUrl)()
                  })
                )
              }
            )
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var OAUTH_SIGN_IN_START = (exports.OAUTH_SIGN_IN_START =
          "OAUTH_SIGN_IN_START");
        var OAUTH_SIGN_IN_COMPLETE = (exports.OAUTH_SIGN_IN_COMPLETE =
          "OAUTH_SIGN_IN_COMPLETE");
        var OAUTH_SIGN_IN_ERROR = (exports.OAUTH_SIGN_IN_ERROR =
          "OAUTH_SIGN_IN_ERROR");
        ...
        function listenForCredentials(
          ...
          if (!resolve) {
            ...
            if (creds && creds.uid) {
              popup.close();
              (0, _sessionStorage.persistData)(
                C.SAVED_CREDS_KEY,
                (0, _parseUrl.normalizeTokenKeys)(creds)
              );
              var currentCreds = (0, _sessionStorage.retrieveData)(
                C.SAVED_CREDS_KEY
              );
              var resourceClass = currentCreds["resource-class"];

              (0, _fetch2.default)(
                (0, _sessionStorage.getTokenValidationPath)(endpointKey) +
                  "?resource_class=" +
                  resourceClass
              )
                .then(_handleFetchResponse.parseResponse)
        ...
        function oAuthSignIn(_ref4) {
          ...
          return function(dispatch) {
            ...
            var url = (0, _sessionStorage.getOAuthUrl)({
              provider: provider,
              params: params,
              currentEndpointKey: currentEndpointKey
            });
      ...
      /***/ function(module, exports) {
        ...
        function openPopup(provider, url, name) {
          return window.open(
            url,
            name,
            settings + "," + getPopupDimensions(provider)
          );
        }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var REQUEST_PASSWORD_RESET_START = (exports.REQUEST_PASSWORD_RESET_START =
          "REQUEST_PASSWORD_RESET_START");
        var REQUEST_PASSWORD_RESET_COMPLETE = (exports.REQUEST_PASSWORD_RESET_COMPLETE =
          "REQUEST_PASSWORD_RESET_COMPLETE");
        var REQUEST_PASSWORD_RESET_ERROR = (exports.REQUEST_PASSWORD_RESET_ERROR =
          "REQUEST_PASSWORD_RESET_ERROR");
        var REQUEST_PASSWORD_RESET_FORM_UPDATE = (exports.REQUEST_PASSWORD_RESET_FORM_UPDATE =
          "REQUEST_PASSWORD_RESET_FORM_UPDATE");

        function requestPasswordResetFormUpdate(endpoint, key, value) {
          return {
            type: REQUEST_PASSWORD_RESET_FORM_UPDATE,
            endpoint: endpoint,
            key: key,
            value: value
          };
        ...
        function requestPasswordReset(body, endpoint) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getPasswordResetRequestUrl)(endpoint),
              {
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json"
                ...
                body: JSON.stringify(
                  (0, _extend2.default)(body, {
                    redirect_url: (0,
                    _sessionStorage.getPasswordResetRedirectUrl)(endpoint)
                  })
                )
              }
            )
              ...
              .then(function(_ref) {
                ...
                return dispatch(
                  requestPasswordResetComplete(endpoint, message)
                );
              })
              .catch(function(_ref2) {
                var errors = _ref2.errors;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var UPDATE_PASSWORD_START = (exports.UPDATE_PASSWORD_START =
          "UPDATE_PASSWORD_START");
        var UPDATE_PASSWORD_COMPLETE = (exports.UPDATE_PASSWORD_COMPLETE =
          "UPDATE_PASSWORD_COMPLETE");
        var UPDATE_PASSWORD_ERROR = (exports.UPDATE_PASSWORD_ERROR =
          "UPDATE_PASSWORD_ERROR");
        var UPDATE_PASSWORD_FORM_UPDATE = (exports.UPDATE_PASSWORD_FORM_UPDATE =
        ...
        function updatePassword(body, endpoint) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getPasswordUpdateUrl)(endpoint),
              {
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json"
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var UPDATE_PASSWORD_MODAL_START = (exports.UPDATE_PASSWORD_MODAL_START =
          "UPDATE_PASSWORD_MODAL_START");
        var UPDATE_PASSWORD_MODAL_COMPLETE = (exports.UPDATE_PASSWORD_MODAL_COMPLETE =
          "UPDATE_PASSWORD_MODAL_COMPLETE");
        var UPDATE_PASSWORD_MODAL_ERROR = (exports.UPDATE_PASSWORD_MODAL_ERROR =
          "UPDATE_PASSWORD_MODAL_ERROR");
        var UPDATE_PASSWORD_MODAL_FORM_UPDATE = (exports.UPDATE_PASSWORD_MODAL_FORM_UPDATE =
          "UPDATE_PASSWORD_MODAL_FORM_UPDATE");

        function updatePasswordModalFormUpdate(endpoint, key, value) {
          return {
            type: UPDATE_PASSWORD_MODAL_FORM_UPDATE,
            endpoint: endpoint,
            key: key,
            value: value
          };
        ...
        function updatePasswordModalComplete(endpoint, user) {
          return {
            type: UPDATE_PASSWORD_MODAL_COMPLETE,
            endpoint: endpoint,
            user: user
          };
        }
        function updatePasswordModalError(endpoint, errors) {
          return {
            type: UPDATE_PASSWORD_MODAL_ERROR,
            endpoint: endpoint,
            errors: errors
          };
        }
        function updatePasswordModal(body, endpointKey) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getPasswordUpdateUrl)(endpointKey),
              {
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json"
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var DESTROY_ACCOUNT_START = (exports.DESTROY_ACCOUNT_START =
          "DESTROY_ACCOUNT_START");
        var DESTROY_ACCOUNT_COMPLETE = (exports.DESTROY_ACCOUNT_COMPLETE =
          "DESTROY_ACCOUNT_COMPLETE");
        var DESTROY_ACCOUNT_ERROR = (exports.DESTROY_ACCOUNT_ERROR =
        ...
        function destroyAccount(endpoint) {
          return function(dispatch) {
            ...
            return (0, _fetch2.default)(
              (0, _sessionStorage.getDestroyAccountUrl)(endpoint),
              { method: "delete" }
            )
              .then(_handleFetchResponse.parseResponse)
              .then(function(_ref) {
                ...
                var defaultEndpointKey = (0,
                _sessionStorage.getDefaultEndpointKey)();

                // set in store
                dispatch(
                  (0, _configure.storeCurrentEndpointKey)(defaultEndpointKey)
                );
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          initialState,
          ((_createReducer = {}),
          _defineProperty(_createReducer, A.AUTHENTICATE_START, function(
            state
          ) {
            return state.set("loading", true);
          }),
          _defineProperty(_createReducer, A.AUTHENTICATE_COMPLETE, function(
            state
          ) {
            return state.merge({
              loading: false,
          ...
          _defineProperty(_createReducer, A.AUTHENTICATE_ERROR, function(
            state
          ) {
            return state.merge({
              loading: false,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          initialState,
          ((_createReducer = {}),
          _defineProperty(_createReducer, A.CONFIGURE_START, function(state) {
            return state.set("loading", true);
          }),
          _defineProperty(
            _createReducer,
          ...
          _defineProperty(_createReducer, A.SET_ENDPOINT_KEYS, function(
            state,
            _ref2
          ) {
          ...
          _defineProperty(_createReducer, A.CONFIGURE_COMPLETE, function(
            state,
            _ref3
          ) {
          ...
          _defineProperty(_createReducer, A.CONFIGURE_ERROR, function(
            state,
            _ref4
          ) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(
            _createReducer,
            authActions.AUTHENTICATE_COMPLETE,
            function(state, _ref) {
              var user = _ref.user;
              return state.merge({
                attributes: user,
          ...
          _defineProperty(
            _createReducer,
            _configure.STORE_CURRENT_ENDPOINT_KEY,
          ...
          _defineProperty(
            _createReducer,
            _emailSignIn.EMAIL_SIGN_IN_COMPLETE,
          ...
          _defineProperty(
            _createReducer,
            _emailSignUp.EMAIL_SIGN_UP_COMPLETE,
          ...
          _defineProperty(
            _createReducer,
            _oauthSignIn.OAUTH_SIGN_IN_COMPLETE,
          ...
          _defineProperty(
            _createReducer,
            ssActions.SS_AUTH_TOKEN_UPDATE,
          ...
          _defineProperty(
            _createReducer,
            authActions.AUTHENTICATE_FAILURE,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            ssActions.SS_TOKEN_VALIDATION_ERROR,
            function(state) {
              return state.merge(initialState);
            }
          ),
          _defineProperty(_createReducer, _signOut.SIGN_OUT_COMPLETE, function(
            state
          ) {
            return state.merge(initialState);
          }),
          _defineProperty(_createReducer, _signOut.SIGN_OUT_ERROR, function(
            state
          ) {
            return state.merge(initialState);
          }),
          _defineProperty(
            _createReducer,
            _destroyAccount.DESTROY_ACCOUNT_COMPLETE,
            function(state) {
              return state.merge(initialState);
            }
          ),
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var requestPasswordResetActions = _interopRequireWildcard(
        ...
        var updatePasswordModalActions = _interopRequireWildcard(
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(
            _createReducer,
            emailSignInActions.EMAIL_SIGN_IN_COMPLETE,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            oAuthSignInActions.OAUTH_SIGN_IN_ERROR,
            function(state) {
              return state.merge({
          ...
          _defineProperty(
            _createReducer,
            oAuthSignInActions.OAUTH_SIGN_IN_START,
            function(state, _ref) {
              var provider = _ref.provider;
              return state.merge({
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_EMAIL_SIGN_IN_SUCCESS_MODAL,
            function(state) {
              return state.set("emailSignInSuccessModalVisible", false);
            }
          ),
          _defineProperty(
            _createReducer,
            uiActions.HIDE_EMAIL_SIGN_IN_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            signOutActions.SIGN_OUT_COMPLETE,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_SIGN_OUT_SUCCESS_MODAL,
            function(state) {
              return state.set("signOutSuccessModalVisible", false);
            }
          ),
          _defineProperty(
            _createReducer,
            uiActions.HIDE_SIGN_OUT_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL,
            function(state) {
              return state.merge({
                emailSignUpSuccessModalVisible: false,
                emailSignUpAddress: null
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_EMAIL_SIGN_UP_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_PASSWORD_RESET_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.SHOW_PASSWORD_RESET_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.SHOW_FIRST_TIME_LOGIN_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_FIRST_TIME_LOGIN_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_PASSWORD_RESET_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.SHOW_PASSWORD_RESET_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            requestPasswordResetActions.REQUEST_PASSWORD_RESET_ERROR,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_REQUEST_PASSWORD_RESET_SUCCESS_MODAL,
            function(state) {
              return state.merge({
                requestPasswordResetSuccessModalVisible: false,
                requestPasswordResetSuccessMessage: null
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_OAUTH_SIGN_IN_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_OAUTH_SIGN_IN_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            updatePasswordActions.UPDATE_PASSWORD_COMPLETE,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            updatePasswordActions.UPDATE_PASSWORD_ERROR,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_UPDATE_PASSWORD_SUCCESS_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_UPDATE_PASSWORD_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            destroyAccountActions.DESTROY_ACCOUNT_COMPLETE,
            function(state, _ref3) {
          ...
          _defineProperty(
            _createReducer,
            destroyAccountActions.DESTROY_ACCOUNT_ERROR,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL,
            function(state) {
              return state.merge({
                destroyAccountSuccessModalVisible: false,
                destroyAccountMessage: null
          ...
          _defineProperty(
            _createReducer,
            uiActions.HIDE_DESTROY_ACCOUNT_ERROR_MODAL,
            function(state) {
          ...
          _defineProperty(
            _createReducer,
            updatePasswordModalActions.UPDATE_PASSWORD_MODAL_COMPLETE,
            function(state) {
              return state.merge({
                passwordResetSuccessModalVisible: false,
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(
            ...
            function(state, _ref) {
              ...
              return state.merge(
                endpoints.reduce(function(coll, k) {
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_IN_START, function(
            state,
            _ref2
          ) {
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_IN_COMPLETE, function(
            state,
            _ref3
          ) {
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_IN_ERROR, function(
            state,
            _ref4
          ) {
            ...
            return state.mergeDeep(
              _defineProperty({}, endpoint, {
                loading: false,
                errors: errors
              })
            );
          }),
          _defineProperty(_createReducer, A.EMAIL_SIGN_IN_FORM_UPDATE, function(
            state,
            _ref5
          ) {
            var endpoint = _ref5.endpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_UP_START, function(
            state,
            _ref2
          ) {
            var endpoint = _ref2.endpoint;
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_UP_COMPLETE, function(
            state,
            _ref3
          ) {
            var endpoint = _ref3.endpoint;
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_UP_ERROR, function(
            state,
            _ref4
          ) {
            var endpoint = _ref4.endpoint,
          ...
          _defineProperty(_createReducer, A.EMAIL_SIGN_UP_FORM_UPDATE, function(
            state,
            _ref5
          ) {
            var endpoint = _ref5.endpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(_createReducer, A.OAUTH_SIGN_IN_START, function(
            state,
            _ref2
          ) {
            var endpoint = _ref2.endpoint;
          ...
          _defineProperty(_createReducer, A.OAUTH_SIGN_IN_COMPLETE, function(
            state,
            _ref3
          ) {
            var endpoint = _ref3.endpoint;
          ...
          _defineProperty(_createReducer, A.OAUTH_SIGN_IN_ERROR, function(
            state,
            _ref4
          ) {
            var endpoint = _ref4.endpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(
            _createReducer,
            A.REQUEST_PASSWORD_RESET_START,
            function(state, _ref2) {
              var endpoint = _ref2.endpoint;
              return state.setIn([endpoint, "loading"], true);
            }
          ...
          _defineProperty(
            _createReducer,
            A.REQUEST_PASSWORD_RESET_COMPLETE,
            function(state, _ref3) {
              var endpoint = _ref3.endpoint;
              return state.merge(_defineProperty({}, endpoint, initialState));
            }
          ...
          _defineProperty(
            _createReducer,
            A.REQUEST_PASSWORD_RESET_ERROR,
            function(state, _ref4) {
              var endpoint = _ref4.endpoint,
                errors = _ref4.errors;
              return state.mergeDeep(
          ...
          _defineProperty(
            _createReducer,
            A.REQUEST_PASSWORD_RESET_FORM_UPDATE,
            function(state, _ref5) {
              var endpoint = _ref5.endpoint,
                key = _ref5.key,
                value = _ref5.value;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(_createReducer, A.UPDATE_PASSWORD_START, function(
            state,
            _ref2
          ) {
            var endpoint = _ref2.endpoint;
          ...
          _defineProperty(_createReducer, A.UPDATE_PASSWORD_COMPLETE, function(
            state,
            _ref3
          ) {
            var endpoint = _ref3.endpoint;
          ...
          _defineProperty(_createReducer, A.UPDATE_PASSWORD_ERROR, function(
            state,
            _ref4
          ) {
            var endpoint = _ref4.endpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(
            _createReducer,
            A.UPDATE_PASSWORD_MODAL_COMPLETE,
            function(state, _ref3) {
              var endpoint = _ref3.endpoint;
              return state.merge(_defineProperty({}, endpoint, initialState));
            }
          ...
          _defineProperty(
            _createReducer,
            A.UPDATE_PASSWORD_MODAL_FORM_UPDATE,
            function(state, _ref5) {
              var endpoint = _ref5.endpoint,
                key = _ref5.key,
                value = _ref5.value;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          initialState,
          _defineProperty({}, A.SS_AUTH_TOKEN_UPDATE, function(state, _ref) {
            var _ref$user = _ref.user,
              ...
              mustResetPassword =
                _ref$mustResetPasswor === undefined
                  ? false
                  : _ref$mustResetPasswor,
              _ref$firstTimeLogin = _ref.firstTimeLogin,
              firstTimeLogin =
                _ref$firstTimeLogin === undefined ? false : _ref$firstTimeLogin;
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(_createReducer, A.SIGN_OUT_START, function(
            state,
            _ref2
          ) {
            var endpoint = _ref2.endpoint;
          ...
          _defineProperty(_createReducer, A.SIGN_OUT_COMPLETE, function(
            state,
            _ref3
          ) {
            var endpoint = _ref3.endpoint;
          ...
          _defineProperty(_createReducer, A.SIGN_OUT_ERROR, function(
            state,
            _ref4
          ) {
            var endpoint = _ref4.endpoint,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.default = (0, _reduxImmutablejs.createReducer)(
          ...
          _defineProperty(_createReducer, A.DESTROY_ACCOUNT_START, function(
            state,
            _ref2
          ) {
            var endpoint = _ref2.endpoint;
          ...
          _defineProperty(_createReducer, A.DESTROY_ACCOUNT_COMPLETE, function(
            state,
            _ref3
          ) {
            var endpoint = _ref3.endpoint;
          ...
          _defineProperty(_createReducer, A.DESTROY_ACCOUNT_ERROR, function(
            state,
            _ref4
          ) {
            var endpoint = _ref4.endpoint,
