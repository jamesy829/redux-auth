...
export const HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL =
  "HIDE_EMAIL_SIGN_UP_SUCCESS_MODAL";
export const HIDE_EMAIL_SIGN_UP_ERROR_MODAL = "HIDE_EMAIL_SIGN_UP_ERROR_MODAL";
export const SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL =
  "SHOW_FIRST_TIME_LOGIN_SUCCESS_MODAL";
export const HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL =
  "HIDE_FIRST_TIME_LOGIN_SUCCESS_MODAL";
export const HIDE_PASSWORD_RESET_SUCCESS_MODAL =
  "HIDE_PASSWORD_RESET_SUCCESS_MODAL";
export const SHOW_PASSWORD_RESET_SUCCESS_MODAL =
  "SHOW_PASSWORD_RESET_SUCCESS_MODAL";
export const SHOW_FIRST_TIME_LOGIN_ERROR_MODAL =
  "SHOW_FIRST_TIME_LOGIN_ERROR_MODAL";
export const HIDE_FIRST_TIME_LOGIN_ERROR_MODAL =
  "HIDE_FIRST_TIME_LOGIN_ERROR_MODAL";
export const HIDE_PASSWORD_RESET_ERROR_MODAL =
  "HIDE_PASSWORD_RESET_ERROR_MODAL";
export const SHOW_PASSWORD_RESET_ERROR_MODAL =
...
export const HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL =
  "HIDE_REQUEST_PASSWORD_RESET_ERROR_MODAL";
export const HIDE_UPDATE_PASSWORD_SUCCESS_MODAL =
  "HIDE_UPDATE_PASSWORD_SUCCESS_MODAL";
export const HIDE_UPDATE_PASSWORD_ERROR_MODAL =
  "HIDE_UPDATE_PASSWORD_ERROR_MODAL";
export const HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL =
  "HIDE_DESTROY_ACCOUNT_SUCCESS_MODAL";
export const HIDE_DESTROY_ACCOUNT_ERROR_MODAL =
