  ...
  renderIcon() {
    ...
    if (this.props.loading) {
      ...
      if (typeof this.props.icon === "object") {
        ...
        icon = (
          <this.props.icon color={color} style={{ width: 15, height: 15 }} />
        );
      }
    }
  ...
  render() {
    ...
    const props = {
      ...
      label: this.props.label || (
        <span style={{ paddingLeft: 15, color }}>{this.props.children}</span>
      ),
    ...
    return (
      <MuiThemeProvider>
        <RaisedButton {...props} onClick={this.handleClick.bind(this)}>
          {this.renderIcon()}
        </RaisedButton>
      </MuiThemeProvider>
    );
