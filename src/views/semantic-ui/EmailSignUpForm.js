...
function mergeProps(stateProps, dispatchProps, ownProps) {
  return Object.assign({}, ownProps, stateProps, dispatchProps, {
    onSubmit: formData => {
      return dispatchProps.emailSignUp(formData.toJS(), stateProps.endpoint)
        .then(ownProps.next)
...
export default connect(mapStateToProps, { emailSignUp }, mergeProps)(reduxForm({})(EmailSignUpFormView));
