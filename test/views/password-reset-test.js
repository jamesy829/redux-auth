...
var requirePath,
  ...
  successResp = {
    message:
      "An email has been sent to test@test.com containing " +
        ...
        describe(`${theme || "default"} theme`, () => {
          ...
          describe(`success`, () => {
            it("should handle successful sign in", done => {
              ...
              renderConnectedComponent(<RequestPasswordResetForm />, { apiUrl })
                .then(({ instance, store }) => {
                  let emailEl = findTag(instance, "input")[0];
                  ...
                  setTimeout(() => {
                    ...
                    // ensure user was set
                    let sentMessage = store
                      .getState()
                      .auth.getIn(["ui", "requestPasswordResetSuccessMessage"]);
              ...
              renderConnectedComponent(<RequestPasswordResetForm />, { apiUrl })
                .then(({ instance, store }) => {
                  ...
                  setTimeout(() => {
                    ...
                    let errors = store
                      .getState()
                      .auth.getIn(["requestPasswordReset", "default", "errors"])
                      .toJS();
