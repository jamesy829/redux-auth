        ...
        describe(`${theme} theme`, () => {
          describe("params", () => {
            it("should accept styling params", done => {
              ...
              renderConnectedComponent(<SignOutButton {...inputProps} />)
                .then(({ instance }) => {
            ...
            it("should allow configuration of endpoint", done => {
              ...
              renderConnectedComponent(<SignOutButton />, endpointConfig, {
              ...
              renderConnectedComponent(
                ...
                .then(({ instance, store }) => {
                  ...
                  setTimeout(() => {
                    ...
                    let errors = store
                      .getState()
                      .auth.getIn(["signOut", "default", "errors"])
                      .toJS();
                    ...
                    let modalVisible = store
                      .getState()
                      .auth.getIn(["ui", "signOutErrorModalVisible"]);
                    expect(modalVisible).to.equal(true);
