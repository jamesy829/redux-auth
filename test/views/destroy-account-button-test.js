        ...
        describe(`${theme || "default"} theme`, () => {
          describe(`params`, () => {
            it("should accept styling params", done => {
              ...
              renderConnectedComponent(<DestroyAccountButton {...inputProps} />)
                .then(({ instance }) => {
                  expect(findClass(instance, "destroy-account-class-override"))
                    .to.be.ok;
                  done();
                })
                ...
                .then(({ instance, store }) => {
                  ...
                  setTimeout(() => {
                    ...
                    let modalVisible = store
                      .getState()
                      .auth.getIn(["ui", "destroyAccountSuccessModalVisible"]);
              ...
              renderConnectedComponent(
                ...
                .then(({ instance, store }) => {
                  ...
                  setTimeout(() => {
                    ...
                    let errors = store
                      .getState()
                      .auth.getIn(["destroyAccount", "default", "errors"])
                      .toJS();
                    ...
                    let modalVisible = store
                      .getState()
                      .auth.getIn(["ui", "destroyAccountErrorModalVisible"]);
                    expect(modalVisible).to.equal(true);
