  ...
  /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _AuthGlobals2 = __webpack_require__(40);
        ...
        var _ButtonLoader2 = __webpack_require__(61);
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _rcDialog = __webpack_require__(43);
                ...
                return this.props.show
                  ? _react2.default.createElement(
                      _rcDialog2.default,
                      {
                        ...
                        className:
                          "redux-auth-modal " + this.props.containerClass,
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var _ButtonLoader = __webpack_require__(61);
      ...
      /***/ function(module, exports, __webpack_require__) {
          ...
          _createClass(ButtonLoader, [
            ...
            },
            {
              ...
              value: function render() {
                ...
                var style = (0, _extend2.default)(
                  { color: color, paddingLeft: 15, position: "relative" },
                  this.props.style
                );
        ...
        ButtonLoader.defaultProps = {
          ...
          children: _react2.default.createElement("span", null, "Submit"),
          style: {}
        };
        ...
        var EmailSignInForm = (function(_React$Component) {
          ...
          _createClass(EmailSignInForm, [
            ...
            },
            {
              ...
              value: function handleInput(key, val) {
                this.props.dispatch(
                  (0, _emailSignIn.emailSignInFormUpdate)(
                    this.getEndpoint(),
                    key,
                    val
                  )
            ...
            },
            {
              ...
              value: function handleSubmit(event) {
                ...
                var formData = this.props.auth
                  .getIn(["emailSignIn", this.getEndpoint(), "form"])
                  .toJS();
                this.props
                  .dispatch(
                    (0, _emailSignIn.emailSignIn)(formData, this.getEndpoint())
                  )
        ...
        var EmailSignUpForm = (function(_React$Component) {
          ...
          function EmailSignUpForm() {
            ...
            return _possibleConstructorReturn(
              this,
              (
                EmailSignUpForm.__proto__ ||
                Object.getPrototypeOf(EmailSignUpForm)
              ).apply(this, arguments)
            );
          }
          ...
          _createClass(EmailSignUpForm, [
            ...
            },
            {
              ...
              value: function handleInput(key, val) {
                this.props.dispatch(
                  (0, _emailSignUp.emailSignUpFormUpdate)(
                    this.getEndpoint(),
                    key,
                    val
                  )
            ...
            },
            {
              ...
              value: function handleSubmit(event) {
                ...
                event.preventDefault();
                var formData = this.props.auth
                  .getIn(["emailSignUp", this.getEndpoint(), "form"])
                  .toJS();
                this.props
                  .dispatch(
                    (0, _emailSignUp.emailSignUp)(formData, this.getEndpoint())
                  )
                  .then(this.props.next)
                  .catch(function() {});
              }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        OAuthSignInButton.defaultProps = {
          signInParams: {},
          children: _react2.default.createElement("span", null, "OAuth Sign In")
        };
        exports.default = (0, _reactRedux.connect)(function(_ref) {
          var auth = _ref.auth;
          return { auth: auth };
